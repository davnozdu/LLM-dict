...
pub struct GeneralConfig {
    ...
    /// Звуковые сигналы приложения: начало и конец диктовки, запуск действия,
    /// ошибка. Системный писк от нераспознанного сочетания к ним не относится —
    /// он убирается `swallow_hotkey`.
